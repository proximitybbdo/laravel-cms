<div class="row {{ "cnt_" . $asset_field_name }}"
    ...
    <div class="col-xs-12 col-md-6 col-sm-8">
        ...
        <div class="input-group">
          ...
          <div class="btn btn-default">              
              <a class="showmanager" data-manager-type="file" data-module="<?= $module_type ?>"
                 data-input="<?= $asset_field_name ?>"><span class="fa fa-folder-open-o"></span></a>
          </div>
          <div class="btn btn-default" style="display:<?= $has_value ? "" : "none" ?>">
              <a style="display:<?= $has_value ? "inline" : "none" ?>"
                 href="<?= url('/uploads/file/' . ($has_value ? $model->file($content[$type])->file : '')) ?>"
                 id="file_content_<?= $type ?>"> <span class="fa fa-download"></span></a>
          </div>
      </span>
        </div>
    </div>
