    ...
    @if($single_item == false)
        @if($show_start_date == true)
            <div class="form-group">
                ...
                {{ Form::text('start_date', null, array('class'=>'js-flatpickr form-control','data-date-format'=>'d-m-Y')) }}
        ...
        @if($show_end_date == true)
            <div class="form-group">
                ...
                {{ Form::text('end_date', null, array('class'=>'js-flatpickr form-control','data-date-format'=>'d-m-Y')) }}
