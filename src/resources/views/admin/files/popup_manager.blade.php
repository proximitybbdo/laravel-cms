...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="<?= asset('assets/admin/font-awesome/css/font-awesome.min.css', config('app.secure_urls')) ?>"
...
<div>
    <div>
        <div class="container-fluid">
            ...
            <form id="myDropzone" class="dropzone dz-clickable" method="POST"
                  action="<?= url("icontrol/files/$manager_type/$module_type/upload") ?>"
                  data-manager-type="<?= $manager_type ?>" data-mode="<?= $mode ?>" data-input="<?= $input_id ?>"
                  data-module="<?= $module_type ?>" data-max-filesize="<?= $maxFileSize ?>"
