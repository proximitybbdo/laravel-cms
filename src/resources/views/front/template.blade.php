<!doctype html>
<!--[if IE 8]>
<html class="no-js ie8" lang="<?= App::getLocale(); ?>"> <![endif]-->
<!--[if IE 9]>
...
<body class="body--{{ Route::currentRouteName() }}" data-page="{{ Route::currentRouteName() }}"
      data-lang="{{App::getLocale()}}">
<!-- Google Tag Manager (noscript) -->
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P6QC2HP"
